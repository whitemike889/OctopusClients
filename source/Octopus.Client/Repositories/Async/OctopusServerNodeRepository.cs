...
namespace Octopus.Client.Repositories.Async
{
    ...
    {
        Task<ResourceCollection<TaskResource>> GetTasks(OctopusServerNodeResource node, int skip = 0, int? take = null,
    ...
    class OctopusServerNodeRepository : BasicRepository<OctopusServerNodeResource>, IOctopusServerNodeRepository
    {
        ...
        public Task<ResourceCollection<TaskResource>> GetTasks(OctopusServerNodeResource node, int skip = 0, int? take = null, string taskState = null)
        {
