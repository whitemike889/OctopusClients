...
namespace Octopus.Client.Repositories.Async
{
    public interface ITaskRepository : IPaginate<TaskResource>, IGet<TaskResource>, ICreate<TaskResource>
    {
        ...
        Task<TaskResource> ExecuteMigrationPartialExport(MigrationPartialExportResource resource, string description = null);
        Task<TaskResource> ExecuteMigrationImport(MigrationImportResource resource, string description = null);
        Task<TaskResource> ExecuteMigration(MigrationResource resource, string description = null);
    ...
    class TaskRepository : BasicRepository<TaskResource>, ITaskRepository
    {
        ...
        public Task<TaskResource> ExecuteMigrationPartialExport(MigrationPartialExportResource migrationResource, string description = null)
        {
            // Validation
        ...
        public Task<TaskResource> ExecuteMigrationImport(MigrationImportResource migrationResource, string description = null)
        {
            // Validation
            // Note: We're not using a validator because this Resource has no corresponding IDocument/DB model.
        ...
        public Task<TaskResource> ExecuteMigration(MigrationResource migrationResource, string description = null)
        {
            // Validation
            // Note: We're not using a validator because this Resource has no corresponding IDocument/DB model.
